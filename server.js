...
function handler(req, res) {
	...
	// ToDo set up default index.html
	★・・・・・・★・・・・・・★・・・・・・★・・・・・・★・・・・・・ */
	switch(action){
		case  '/':
		...
		case '/sound/se03.ogg':
			...
			break;
		case '/sound/se04.ogg':
			var seOgg4 = fs.readFileSync('./sound/se04.ogg');
			res.writeHead(200, {'Content-Type':'audio/ogg' });
			res.end(seOgg4, 'binary');
			break;
		case '/sound/se05.ogg':
			var seOgg5 = fs.readFileSync('./sound/se05.ogg');
			res.writeHead(200, {'Content-Type':'audio/ogg' });
			res.end(seOgg5, 'binary');
			break;
		case '/sound/se06.ogg':
			var seOgg6 = fs.readFileSync('./sound/se06.ogg');
			res.writeHead(200, {'Content-Type':'audio/ogg' });
		...
		case '/sound/se03.mp3':
			...
			break;
		case '/sound/se04.mp3':
			var seMp4 = fs.readFileSync('./sound/se04.mp3');
			res.writeHead(200, {'Content-Type':'audio/mp3' });
			res.end(seMp4, 'binary');
			break;
		case '/sound/se05.mp3':
			var seMp5 = fs.readFileSync('./sound/se05.mp3');
			res.writeHead(200, {'Content-Type':'audio/mp3' });
			res.end(seMp5, 'binary');
			break;
		case '/sound/se06.mp3':
			var seMp6 = fs.readFileSync('./sound/se06.mp3');
			res.writeHead(200, {'Content-Type':'audio/mp3' });
		...
		case '/sound/se03.wav':
			...
			break;
		case '/sound/se04.wav':
			var seWav4 = fs.readFileSync('./sound/se04.wav');
			res.writeHead(200, {'Content-Type':'audio/wav' });
			res.end(seWav4, 'binary');
			break;
		case '/sound/se05.wav':
			var seWav5 = fs.readFileSync('./sound/se05.wav');
			res.writeHead(200, {'Content-Type':'audio/wav' });
			res.end(seWav5, 'binary');
			break;
		case '/sound/se06.wav':
			var seWav6 = fs.readFileSync('./sound/se06.wav');
			res.writeHead(200, {'Content-Type':'audio/wav' });
